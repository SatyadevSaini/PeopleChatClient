					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="login" method="post" data-toggle="validator" class="form-horizontal">
								...
								<div class="g-recaptcha" data-sitekey="6LeOXC4gAAAAAMl1XTj0_WiidcRW3rzxEWpizMTv"></div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="loginGoogle" class="navbar-form navbar-left">
							  <div class="form-group">
							    <input type="email" name="email" placeholder="Enter Your Email!" required class="form-control" placeholder="Search">
							  </div>
							  <button type="submit" class="btn btn-default">Login using Google</button>
							</form>
						</div>
					</div>
				</div>
